...
const HailEstimateManualForm = ({
  estimateHail,
}: {
  estimateHail?: EstimateHail;
}) => {
  const t = useTranslations("PageEstimates");
  const terror = useTranslations("Settings.Matrix");
  ...
  const createHailEstimate = useMutation({
    mutationFn: async (formData: CreateEstimateHail) => {
      const res = await hailEstimate(formData);
      return res;
    },
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="grid w-full grid-cols-1 gap-6 py-4 md:grid-cols-2 lg:grid-cols-3">
                          <div>
                            ...
                            <div className="flex gap-2">
                              ...
                              />
                              <HailInput
                                fieldName={`estimateHailPanel.${index}.lightQuotient`}
                                panelName={panel.id}
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              ...
                              />
                              <HailInput
                                fieldName={`estimateHailPanel.${index}.mediumQuotient`}
                                panelName={panel.id}
                                startIcon={<Euro size={16} />}
                              />
                            </div>
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              ...
                              />
                              <HailInput
                                fieldName={`estimateHailPanel.${index}.strongQuotient`}
                                panelName={panel.id}
                                startIcon={<Euro size={16} />}
                              />
                            </div>
...
export default HailEstimateManualForm;
